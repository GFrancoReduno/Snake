...
img_reset = Image.open('images/reset.png')
img_reset = ImageTk.PhotoImage(img_reset)

canvas = tk.Canvas(window, highlightthickness=0, bg= "DeepSkyBlue")
canvas.place(relwidth=1, relheight=1)

text_score = canvas.create_text(50,50, text="0", fill= "white", font=("firacode", 30))
...
def reset_game():
    ...
    canvas.coords(img_pipe_down, 1200, 550)
...
def game_end():
    ...
    bt_reset.place(relx = 0.5, rely =0.7, acnhor = 'center')
   

lbl_game_over = tk.Label(window, text = "Game Over !", font=("firacode", 30), fg = "white", bg = "DeepSkyBlue")
bt_reset = tk.Button(window, border = 0, image = img_reset, activebackground="DeepSkyBlue", bg = "DeepSkyBlue", command = reset_game)
