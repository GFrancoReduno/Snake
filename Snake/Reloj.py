...
frame_hora = Frame()
frame_hora.pack()
etiqueta_hm= Label(frame_hora, font=("DS-Digital", 100), text="H:M")
etiqueta_hm.grid(row=0, column=0)

etiqueta_s=Label(frame_hora, font=("DS-Digital", 50), text="s")
etiqueta_s.grid(row=0, column=1, sticky="n")

etiqueta_fecha = Label(font=("DS-Digital", 50), text="dia d/m/aaaa")
