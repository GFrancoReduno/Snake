...
def movimiento():
    ...
    if posicion_food == posicion_snake[0]:
        ...
        canvas.create_text(*posicion_snake[-1], text= "■", fill="green2",font = ("firacode", 20), tag = "snake")
...
canvas.create_text(75,75, text="🍎", fill="red2", font= ("firacode",18),tag = "food")
...
cantidad = Label(frame_1, text="cantidad 🍎:", bg="black", fg="red", font= ("firacode", 12, "bold"))
